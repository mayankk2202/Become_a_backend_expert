...
public class ListTeacher extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (se != null) {
			List<LATeacher> masterlist = dao.listTeacherMaster();
			 ...
			 out.println("<table><tr><b><th>Teacher Code</th><th>First Name</th><th>Last Name</th></b></tr>");
			 
			 for (int i=0;i<masterlist.size();i++) {
				out.println("<tr><td>"+masterlist.get(i).gettID()+"</td><td>"+masterlist.get(i).getFname()+"</td><td>"+masterlist.get(i).getLname()+"</td></tr>");
			 }
