...
public class ListT2CMap extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (se != null) {
			Record[] qryRes = dao.ListMappings("T2CMap");
			
			out.println("<!DOCTYPE html><html><head><meta charset=\"ISO-8859-1\"><title>Teacher to Class Mapping</title>"
					 +"<style>table, th, td {border: 1px solid black;border-collapse: collapse;}</style></head><body>");
			out.println("<div align=\"center\"><h3>The Teacher to Class Mapping Table is as follows:</h3>");
